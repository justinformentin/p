...
// const isPartiallyActive = ({ isPartiallyCurrent }: { isPartiallyCurrent: boolean }) =>{
  const isPartiallyActive = ({ isCurrent }) =>  isCurrent ? { className: 'navlink-active navlink' } : { className: 'navlink' }
      ...
      <>
        ...
        <Wrapper>
          ...
          <SideBarInner bg={color}>
            ...
            <Nav color={color}>
              <NavItemWrap>
                <PartialNavLink to="/" >Home</PartialNavLink>
                  <PartialNavLink to="/code" >Code</PartialNavLink>
                  <PartialNavLink to="/general" >General</PartialNavLink>
                  <PartialNavLink to="/blog" >All Posts</PartialNavLink>
